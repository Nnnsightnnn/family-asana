...
- ✅ D5 — offsite backups to Cloudflare R2 (live on `ncit`: 7-day lifecycle, 6h push + weekly verify schtasks)
...
- R2 bucket has a lifecycle rule expiring objects after 7 days
