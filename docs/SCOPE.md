...
- **Backups matter more than you think** — if the SQLite file goes, the family's task list goes. Scheduled offsite copy to Cloudflare R2 (every 6 h, 7-day retention, weekly integrity check) is non-negotiable.
